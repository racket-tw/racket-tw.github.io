...
@(itemlist
  @item{@(link "https://docs.racket-lang.org/reference/match.html" "pattern matching")}
  @item{@(link "https://docs.racket-lang.org/reference/case.html" "case")}
